...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      animate={{ opacity: 1,y:0 }}
      >Unleash your creativity with AI.Turn your text into Imagination into visual art just in seconds - just type, and watch magic happen. </motion.p>
      ...
      >
        {Array(6).fill('').map((item, index) => (
          <motion.img className='rounded hover:scale-105 transition-all duration-300 cursor-pointer max-sm:w-10' src={index % 2 === 0 ? assets.sample_img_2 : assets.sample_img_1} alt="" key={index} width={70}
